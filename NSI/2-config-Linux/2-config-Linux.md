...
Voici <a download="https://raw.githubusercontent.com/FranckCHAMBON/ClasseVirtuelle/master/NSI/2-config-Linux/auto_install.sh">un script à sauvegarder</a> dans votre machine ; il s'appelle `auto_install.sh`
