# Correction de [Solitaire](https://prologin.org/train/2003/semifinal/solitaire)
...
* Lignes trop longues ; on ne met de commentaires que si le code n'est pas explicite.
    ...
    * Placer les commentaires nécessaires juste avant ; comme une justification en mathématiques : **avant**.
