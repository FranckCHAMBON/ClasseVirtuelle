...
* Faire des *doctest* plus simples.
...
* Il faut éviter les `continue` si possible. Ici il suffisait de mieux écrire les tests, en particulier en utilisant des négations.
