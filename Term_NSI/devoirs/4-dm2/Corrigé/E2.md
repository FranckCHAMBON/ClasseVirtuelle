# Correction de [Escalier](https://prologin.org/train/2003/semifinal/escalier)
...
* Bien, mais il n'y a pas de tests pour le *doctest* ; il y avait une difficulté avec ce problème.
...
* Un `"".join` pour une valeur **constante**... autant utiliser `"X" * longueur`.
...
* *doctest* à aérer.
* C'est bien, tu as échappé les contre-obliques ; c'est correct, mais lourd et peu pertinent de renvoyer l'escalier...
